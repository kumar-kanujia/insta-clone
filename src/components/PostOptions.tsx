      ...
      <DialogContent className="dialogContent">
        {isPostMine && (
          <form
            ...
            className="postOption bottom-0 "
          >
            <input type="hidden" name="id" value={post.id} className="hidden" />
            <SubmitButton className="text-red-500 font-bold disabled:cursor-not-allowed w-full p-3 !border-red-500">
              Delete post
            </SubmitButton>
          </form>
        )}
